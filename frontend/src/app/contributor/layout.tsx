...
import { Map, List, Brain, Search, BarChart2, Activity } from "lucide-react";
      ...
      <aside className="w-64 border-r border-border-color bg-surface/50 backdrop-blur-md flex flex-col fixed h-full z-20">
        <div className="p-6 border-b border-border-color flex items-center space-x-3">
          <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-primary to-secondary p-[2px]">
            <img src="https://github.com/torvalds.png" alt="User" className="w-full h-full rounded-full border-2 border-background" />
          </div>
          <div>
            <h3 className="text-sm font-bold text-text-primary">torvalds</h3>
            <span className="text-xs text-success bg-success/10 px-2 py-0.5 rounded-full inline-block mt-1">Contributor</span>
          </div>
        </div>
